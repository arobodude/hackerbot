...
int main() {
    ...
    // Set the decompression buffer size to 43708 bytes (original uncompressed size)
    int original_size = 43708;  // Known uncompressed size
    ...
    // Print the decompressed data in hex format (useful for binary data)
